...
######
##  Example)
##  $./ADMIXTOOLS.pl -p [parameter file] -o [out directory]
##
##  Input
##   Parameter file
##
...
if ($help == 1 || !$param_f) {
	print STDERR "usage:\n\$./ADMIXTOOLS.pl -p PARAM -s SAMPLE_PARAM  -o OUT_DIR \n\n";
...
print FW "indivname: $plink_prefix.ped\n";
...
`echo "$pop3 -p $pop3dir/par_3pop 1>$pop3dir/$result_prefix.3pop.out 2> $pop3dir/3pop.log" > $pop3dir/pop3.CMD`;
