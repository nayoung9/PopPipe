...
sub CreateDistructCommands
{
	...
	if (!defined $drawParamsFile) {
		$drawParamsFile = "/Programs/CLUMPAK/26_03_2015_CLUMPAK/CLUMPAK/distruct/drawparams";
	}
	...
	my $distructExe = "/Programs/CLUMPAK/26_03_2015_CLUMPAK/CLUMPAK/distruct/distruct1.1";
