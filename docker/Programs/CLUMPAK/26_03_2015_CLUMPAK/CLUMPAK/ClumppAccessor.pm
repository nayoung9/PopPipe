...
sub CreateCLUMPPBashFile
{
	...
	my @clummpCommands;
	my $defaultParamFile = "/Programs/CLUMPAK/26_03_2015_CLUMPAK/CLUMPAK/CLUMPP/paramfile";
	my $paramFileName = "clumpp.paramfile";
	my $CLUMPPexe        = "/Programs/CLUMPAK/26_03_2015_CLUMPAK/CLUMPAK/CLUMPP/CLUMPP";
